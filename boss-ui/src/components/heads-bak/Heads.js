...
//     render() {
//         console.log("c_ HEADS NEEDS TO BE FIXED")
//         const heads = this.state.heads.map((head, i) => {
//             return <div>HEAD</div> //<Head.... this needs to be fixed            
//         });

//         return (
//             <div style={{ textAlign: "left" }} className="Heads">
